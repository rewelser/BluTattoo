...
import type {DateRange, RecurrentEventItem} from "./types.ts";
import {Temporal} from "temporal-polyfill";
import {weekdayTypes} from "./defs.ts";
import Duration = Temporal.Duration;
import {getBySetPos, getMonthRange, latest, soonest, startOfWeek} from "./selectors.ts";
...
export function expandRecurrentEventOccurrencesFromRange(rev: RecurrentEventItem, range: DateRange): EventItem[] {
    ...
    console.table({
        ...
        "range.endExclusive": range.endExclusive.toString(),
        revStart: revStart.toString(),
        revVirtualUntil: revVirtualUntil.toString(),
        overlaps: overlaps.toString(),
    });
