    ...
    const handlePointerMove = (e: React.PointerEvent) => {
        ...
        // If two pointers are down, check for pinch gestures
            ...
            if (!pinchCenterRef.current) {
                ...
                setPinchTranslateX(prev => prev + dx);
                setPinchTranslateY(prev => prev + dy);

                pinchCenterRef.current = { x: centerX, y: centerY };
            }

            // setPinchTranslateX(centerX);
            // setPinchTranslateY(centerY);
            // setPinchTranslateX(e.clientX);
            // setPinchTranslateY(e.clientX);
