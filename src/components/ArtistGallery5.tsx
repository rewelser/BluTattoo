...
// NEW: threshold for drag-to-close in px
...
export const ArtistGallery: React.FC<ArtistGalleryProps> = ({ images = [] }) => {
  ...
  // NEW: vertical drag handlers
  const handleDragPointerDown = (e: React.PointerEvent<HTMLDivElement>) => {
    draggingRef.current = true;
    startYRef.current = e.clientY;
    // capture pointer so move/up events keep coming even if you drift off the element
      ...
      {isOpen && currentImage && (
        <LightboxPortal>
          <div
            ...
            // optional: kill wheel scroll so body doesn't try to move
          ...
          >
            ...
            <div className="flex-1 flex items-center justify-center">
              <div
                ref={scrollRef}
                className="flex w-screen overflow-x-auto snap-x snap-mandatory scroll-smooth space-x-4 px-4 scrollbar-color: auto; touch-pan-x"
                style={{
