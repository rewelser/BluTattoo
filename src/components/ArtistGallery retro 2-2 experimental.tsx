            ...
            {images.length > 1 && (
              <>
                ...
                //   onClick={(e) => { e.stopPropagation(); showPrev(); }}
                    ...
                    className="absolute left-6 top-1/2 -translate-y-1/2 flex text-white bg-black/40 backdrop-blur-sm px-5 py-5"
                >
                  ←
                </a>
                <a
                    ...
                    className="absolute right-6 top-1/2 -translate-y-1/2 flex text-white bg-black/40 backdrop-blur-sm px-5 py-5"
                >
                  →
                </a>
              </>
