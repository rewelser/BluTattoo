...
import { ArtistGalleryThumbnailGrid } from "./ArtistGalleryThumbnailGrid.tsx";
...
interface ArtistImage {
    src: string;
    // thumbSrc?: string; // Not needed if doing thubms in pure astro
    alt?: string;
}
...
export const ArtistGallery: React.FC<ArtistGalleryProps> = ({ images = [] }) => {
    ...
    useEffect(() => {
        const handler = (e: Event) => {
            ...
            setStartIndex(custom.detail.index);
            setIsOpen(true);
        };
    ...
    return (
        <>
            {/* No longer using ArtistGalleryThumbnailGrid in this component */}
